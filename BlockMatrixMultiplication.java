...
public class BlockMatrixMultiplication {
    ...
    public static void main(String[] args) throws Exception {
       ...
       conf.set("m", "512");
        conf.set("n", "512");
        conf.set("p", "512");
        conf.set("s", "4"); // Number of rows in a block in A.
        conf.set("t", "4"); // Number of columns in a block in A = number of rows in a block in B.
        conf.set("v", "4"); // Number of columns in a block in B.
