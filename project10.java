...
BufferedImage imag=ImageIO.read(new File(value.toString()));
...
context.write(value,value);
        ...
        public static class ImageReducer extends Reducer<Object,Text,Text,Text> {
 
              public void reduce(Object key, Text value, Context context)
 ...
 */
                ...
                job.setJarByClass(project10.class);
